...
class Mahasiswa extends MY_Controller {
	...
	{
		return $this->generate_table_mahasiswa();
	}
	...
	private function generate_table_mahasiswa()
	{
		...
		foreach ($semua_mahasiswa as $mahasiswa) {
			$this->table->add_row($mahasiswa->nim, $mahasiswa->nama, $mahasiswa->ibu_kota,
				$mahasiswa->telepon, anchor('mahasiswa/print/'.$mahasiswa->nim, 'Print', 'target="blank"').' | '.
