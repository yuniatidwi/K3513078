...
class MY_Controller extends CI_Controller {
	...
	//hanya bisa dipanggil ketika ada public funtion yang memangging fungsi show page ini (bisa dari kontroler lain)
